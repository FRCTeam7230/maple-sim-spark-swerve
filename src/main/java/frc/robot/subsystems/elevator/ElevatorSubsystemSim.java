...
public class ElevatorSubsystemSim extends SubsystemBase implements AutoCloseable {
  ...
  private final ExponentialProfile m_profile =
      new ExponentialProfile(
          ExponentialProfile.Constraints.fromCharacteristics(
              Constants.ElevatorSimConstants.kElevatorMaxV, Constants.ElevatorSimConstants.kElevatorkV, Constants.ElevatorSimConstants.kElevatorkA));

  private ExponentialProfile.State m_setpoint = new ExponentialProfile.State(0, 0);

  // Standard classes for controlling our elevator
  private final PIDController m_pidController =
      new PIDController(Constants.ElevatorSimConstants.kElevatorKp, Constants.ElevatorSimConstants.kElevatorKi, Constants.ElevatorSimConstants.kElevatorKd);

  ElevatorFeedforward m_feedforward =
      new ElevatorFeedforward(
          Constants.ElevatorSimConstants.kElevatorkS,
          Constants.ElevatorSimConstants.kElevatorkG,
          Constants.ElevatorSimConstants.kElevatorkV,
          Constants.ElevatorSimConstants.kElevatorkA);
  private final Encoder m_encoder =
      new Encoder(Constants.ElevatorSimConstants.kEncoderAChannel, Constants.ElevatorSimConstants.kEncoderBChannel);
